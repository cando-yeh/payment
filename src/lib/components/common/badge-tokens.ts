...
export const APP_BADGE_PRESET: Record<string, AppBadgePreset> = {
    ...
    "status.pending_create": {
        tone: "status.pending_create",
        label: "待審核 (新增)",
    },
    "status.pending_update": {
        tone: "status.pending_update",
        label: "待審核 (更新)",
    },
    "status.pending_disable": {
        tone: "status.pending_disable",
        label: "待審核 (停用)",
    },
    "status.draft": { tone: "status.draft", label: "草稿" },
    "status.pending_manager": {
        tone: "status.pending_manager",
        label: "待主管審核",
    },
    "status.pending_finance": {
        tone: "status.pending_finance",
        label: "待財務審核",
    },
    "status.pending_payment": {
        tone: "status.pending_payment",
        label: "待付款",
    },
    "status.paid": { tone: "status.paid", label: "已撥款" },
    "status.paid_pending_doc": {
        tone: "status.paid_pending_doc",
        label: "待補件",
    },
    "status.pending_doc_review": {
        tone: "status.pending_doc_review",
        label: "待補件審核",
    },
